...
$sql1 = "SELECT ID, classify FROM employee where ID = $int";
...
<?php while ($row1 = $result1->fetch_assoc()): ?>
  <div>
    ...
    <form action="editlog2.php" method="post">
    <input type="hidden" name="employeeid" value="<?php echo $row1['ID']; ?>">
    <input type="hidden" name="logid" value="<?php echo $row2['ID']; ?>">
    <input type="hidden" name="classify" value="<?php echo $row1['classify']; ?>">
    <td class="buttons"><button type="submit">Edit</button></td>
    </form>
    </tr>
  </div>
