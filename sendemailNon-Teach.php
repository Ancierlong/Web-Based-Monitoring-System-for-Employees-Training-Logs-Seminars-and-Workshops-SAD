...
$sql = "SELECT ID, title, dateofseminar, venue, remarks, classify, empid FROM employeelogs WHERE classify LIKE 'Non-Teaching' ORDER BY dateofseminar DESC";
...
try {
    ...
    $mail->setFrom('');
    $mail->addAddress('');
    $mail->Subject = 'Request for Training Logs - Non-Teaching Classification';
